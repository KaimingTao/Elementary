## Language and symbol are references to real things, but not real.
...
## How we know if a model is correct
...
## Communication is a fundamental building block
...
## How to find the path from what we want and what we're?
...
## Books mostly give us some thinking framework, but not details
...
## Building thinking toolkits

tags: Thinking

---

## As we simplify things unload unnecessary thinking burden, we can go further more with confidence

tags: Thinking

---

## Learn how to think and understand is for enjoying life
...
## Solving a problem may take several days, or years, be patient sometimes

tags: Solving problem

---

## Expression isn’t communication, but it can serve both purposes.
...
## A good person can communicate with themselves efficiently
...
## I think I made mistakes a lot, and thought ways to prevent repeating them.

tags: Be better

---

## Understand what happened when we face important quetions, then we can go forward

tags: Solve problem

---

## Don’t blame yourself or anyone, that’s a mind trap, focus on do right things
...
## To communicate with others we need make sure
...
## Cooperate with people who cannot communicate, how?
...
## Everything is about ways of communication

tags: Communicate

---

## There's no method that can solve all problems

tags: Trick,Theory

---

## If an idea cannot benefit us in real life, just delete it, find a new one

tags: Encourage

---

## Pragmatism is not some ideology
...
## Be an active Thinker and do something.
...
## Our sense collect data from the environment. In this internet world, the data are tooooo much
...
## If we don’t want to live in confusion but live in clear mind?
...
## Being too serious would absorb too many noises. Need keep some balance.
